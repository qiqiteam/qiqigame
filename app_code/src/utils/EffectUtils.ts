module xlLib {
    export class EffectUtils {
        ...
        // 存储旋转对象
        private static rotationArr: Array<any> = [];
        //对象旋转特效
        //obj   旋转对象
        //time  旋转一周用时，毫秒
        public static rotationEffect(obj, time: number = 1000): void {
        ...
        //取消对象旋转
        //obj    旋转对象
        public static removeRotationEffect(obj): void {
            if (this.rotationArr == null) {
                this.rotationArr = [];
            }
        ...
        //抖动对象特效
        // 1：抖动  2：震动
        public static shakeScreen(panel, effectType: number = 1): void {
        ...
        * obj           对象
        */
        public static playScaleEffect(obj): void {
            var onComplete1: Function = function () {
                if (obj != null) {
                    var onComplete2: Function = function () {
                        obj.scaleX = 1;
        ...
        * todo          多个对象跳动
        */
        public static flyObj(obj, time, space: number = 50): void {
            var onComplete1: Function = function () {
                if (obj != null) {
                    var onComplete2: Function = function () {
