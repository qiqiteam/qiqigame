class NiuNiuView extends eui.Component {
    constructor() {
        super();
        this.skinName = "BaiRenNiuNiuSkin";
        //this.r = r;
    }
    private r: any = null;
...
public grpHead6:eui.Group;
public imghead6:eui.Image;
public labelHead6:eui.Label;
public grpHead7:eui.Group;
public imghead7:eui.Image;
public labelHead7:eui.Label;
public grpHead8:eui.Group;
public imghead8:eui.Image;
public labelHead8:eui.Label;
public grpHead9:eui.Group;
public imghead9:eui.Image;
public labelHead9:eui.Label;
...
*/
    ...
    private showGameTips(type): void {
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getSoundEffect(type));
    ...
    private showCoins(num, index): void {
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getSoundEffect(8));
        var point: egret.Point = NiuNiuUtil.getInstance().getCoinsPos(index);
    ...
    private playCardFly(): void {
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getSoundEffect(6));
    ...
    private playerCardRotation(): void {
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getSoundEffect(7));
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getCardMusicType(poke[index + 1].type));
    ...
    private bankerCardRotation(): void {
        ...
        this.playClickSound(NiuNiuUtil.getInstance().getCardMusicType(poke.type));
    ...
    private showGameResult(): void {
        ...
        if (this.maxUserData != null) {
            ...
            if (this.maxUserData.name == GlobalData.user.nickname) {
                this.playClickSound(NiuNiuUtil.getInstance().getSoundEffect(1));
            }
        }
        else {
