...
class LobbyView extends eui.Component {
	...
	private initGameIconList(): void {
		let allgameList: GameIconData[] = [
			new GameIconData().initData({ name: "通比牛牛", url: "tbnn_game_870_bg", ishot: true, isOpen: true,isNew:false, game: Const.GAME_NIUNIU, type: Const.TYPE_TBNN }),
			new GameIconData().initData({ name: "炸金花", url: "zjh_game_230_bg", ishot: true, isOpen: true,isNew:false, game: Const.GAME_ZHAJINHUA, type: Const.TYPE_JINGDIANJINHUA }),
			new GameIconData().initData({ name: "百家乐", url: "bjl_game_18_bg", ishot: true, isOpen: true,isNew:false, game: Const.GAME_BAIJIALE, type: Const.TYPE_JINGDIANBAIJIALE }),
			new GameIconData().initData({ name: "二八杠", url: "ebg_game_720_bg", ishot: true, isOpen: true,isNew:false, game: Const.GAME_ERBAGANG, type: Const.TYPE_ERBAGANGJINDIAN }),
			new GameIconData().initData({ name: "百人牛牛", url: "brnn_game_930_bg", ishot: true, isOpen: true,isNew:true, game: Const.GAME_NIUNIU, type: Const.TYPE_QRNIUNIU })
		]
		...
		this.qznnGameIconData = new GameIconData().initData({ name: "抢庄牛牛", url: "qznn_game_830_bg", ishot: true,isNew:false, isOpen: true, game: Const.GAME_NIUNIU, type: Const.TYPE_QZNN });
