 ...
 * 游戏中显示用户信息
 */
var BJLHead = (function (_super) {
    __extends(BJLHead, _super);
    function BJLHead() {
        var _this = _super.call(this) || this;
        _this.skinName = "QZNNHeadSkin";
        return _this;
    }
    BJLHead.prototype.childrenCreated = function () {
     ...
     * _imghead 头像图片
     */
    BJLHead.prototype.setUserInfo = function (_name, _gold, _imghead) {
        this.imghead.source = _imghead;
        this.labelName.text = _name;
        this.labelGold.text = _gold;
    };
    BJLHead.prototype.setZhuang = function (value) {
        this.img_zhuang.visible = value;
    };
    BJLHead.prototype.destroy = function () {
    };
    return BJLHead;
}(eui.Component));
__reflect(BJLHead.prototype, "BJLHead");
//# sourceMappingURL=BJLHead.js.map