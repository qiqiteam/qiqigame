...
var TBNNUtil = (function () {
    function TBNNUtil() {
        if (TBNNUtil.instance) {
            throw new Error("Instance is alreally exist");
        }
    }
    TBNNUtil.getInstance = function () {
        if (this.instance == null) {
            this.instance = new TBNNUtil();
        }
        return this.instance;
    };
    //获取筹码数量    1w  10w     100w    1000w   5000w   1y
    TBNNUtil.prototype.getBetNumber = function (index) {
        switch (index) {
            case 0:
    ...
    TBNNUtil.prototype.getMsgSource = function (type) {
        var src = '';
        switch (type) {
            case 2:
                src = 'nn.d2';
    ...
    TBNNUtil.prototype.getCoinsPos = function (index) {
    ...
    TBNNUtil.prototype.getCardType2 = function (index) {
        switch (index) {
            case 0:
                return '无牛';
            case 1:
    ...
    TBNNUtil.prototype.getCardType = function (index) {
        switch (index) {
            case 0:
                return 'nn.n1';
            case 1:
    ...
    TBNNUtil.prototype.getCardMusicType = function (index) {
        switch (index) {
            case 0:
                return 'nn.niu0';
            case 1:
    ...
    //筹码类型
    TBNNUtil.prototype.coinsType = function (num) {
        var coinArr = [];
        var coinNum = 0;
        var src = '';
    ...
    TBNNUtil.prototype.coinPos = function () {
    ...
    TBNNUtil.prototype.getSoundEffect = function (type) {
        switch (type) {
            case 0:
                return 'bgm'; //背景音乐
            case 1:
    ...
    TBNNUtil.instance = null;
    return TBNNUtil;
}());
__reflect(TBNNUtil.prototype, "TBNNUtil");
//# sourceMappingURL=TBNNUtil.js.map