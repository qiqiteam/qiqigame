    ...
    export class SoundMgr {
        ...
        public static get instance(): SoundMgr {
            ...
            if (this._instance == null) {
                ...
                Utils.getLocalStorage(SoundMgr.SOUND_TOGGLE, function (data) {
                    if (data != null) {
                        self._instance.soundOpen = Boolean(Number(data));
                    }
                });

                Utils.getLocalStorage(SoundMgr.MUSIC_TOGGLE, function (data) {
                    if (data != null) {
        ...
        public set musicOpen(b: boolean) {
            ...
            if (!b)
                ...
                this.resumeBgMusic();
            Utils.setLocalStorage(SoundMgr.MUSIC_TOGGLE, Number(this._musicOpen));
        }
        ...
        public set soundOpen(b: boolean) {
            this._soundOpen = b;
            Utils.setLocalStorage(SoundMgr.SOUND_TOGGLE, Number(this._soundOpen));
        }
