class ComBox extends eui.Component
{
	...
	{
		let item:ComBoxItem = evt.target as ComBoxItem;
		if(!item)return;
		if(this.cb)
		{
	...
	public setComBoxData(dataSource:Array<ComBoxData>,cb?: Function, thisArg?: any):void
	{
		this.cb = cb;
